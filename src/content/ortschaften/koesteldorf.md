...
<figure class="media" style="max-width:700px;">
  <img src="/images/koesteldorf-wege.jpg" alt="Kösteldorf - Wege">
  <figcaption>
    Die beiden Hauptwege von Pechgrün nach Kösteldorf.
  </figcaption>
</figure>
...
<figure class="media" style="max-width:450px;">
  <img src="/images/koesteldorf-spitzberg.jpg" alt="Kösteldorf - Spitzberg">
  <figcaption>
    Auf dem Spitzberg (618,3 m).<br>
    Der Gipfelbereich ist heute weitgehend zugewachsen; eine Aussicht auf die Abraumhalde von Pechgrün ist nicht mehr möglich.
  </figcaption>
</figure>

<figure class="media" style="max-width:700px;">
  <img src="/images/koesteldorf-haeuser-1.jpg" alt="Kösteldorf - Häuser 1">
  <figcaption>
    Häuser in Kösteldorf.<br>
    Locker angeordnete Gebäude auf der Hochfläche, eingebettet in Gärten und alte Baumbestände.
  </figcaption>
</figure>

<figure class="media" style="max-width:700px;">
  <img src="/images/koesteldorf-haeuser-2.jpg" alt="Kösteldorf - Häuser 2">
  <figcaption>
    Wohnhäuser und Gärten in Kösteldorf.<br>
    Der Ort wirkt heute gepflegt, ruhig und offen.
  </figcaption>
</figure>

<figure class="media" style="max-width:700px;">
  <img src="/images/koesteldorf-spielplatz.jpg" alt="Kösteldorf - Spielplatz">
  <figcaption>
    Spielplatz in Kösteldorf.<br>
    Offene Fläche am Ortsrand, heute ein Treffpunkt für Kinder und Familien.
  </figcaption>
</figure>

<figure class="media" style="max-width:700px;">
  <img src="/images/koesteldorf-gasthaus.jpg" alt="Kösteldorf - Gasthaus">
  <figcaption>
    Wirtshaus „Gastfreundschaft unter den Kastanien“ in Kösteldorf.<br>
